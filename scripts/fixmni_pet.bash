...
for preproc in ../data/petrest_{rac[12],dtbz}/MHRest_FM_ica/1*_2*/{bgrnaswudktm_func_4.nii.gz,brnaswudktm_func_4.nii.gz,wudktm_func.nii.gz} \
               ../data/pet_frog/MHTask_pet/1*_2*/[1-6]_*/{nfswudktm_func_5.nii.gz,wudktm_func.nii.gz}; do
 fixto1809c $preproc &
 sleep .1
 waitforjobs 20
done
